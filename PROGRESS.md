...
## Volume shader uniform fix
- Declared projection/model-view uniforms in the fragment shader so depth writes compile and the 3D volume renders again with the depth buffer enabled.
