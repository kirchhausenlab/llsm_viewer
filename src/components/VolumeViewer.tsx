...
import type { UseVolumeViewerVrResult } from './volume-viewer/useVolumeViewerVr';
import {
...
function VolumeViewer({
  ...
  const vrFallback = useMemo<UseVolumeViewerVrResult>(() => {
    ...
    return {
      ...
      vrHudPlaneRef: createMutableRef(new THREE.Plane()),
      vrHudPlanePointRef: createMutableRef(new THREE.Vector3()),
      vrPlaybackHudDragTargetRef: createMutableRef(new THREE.Vector3()),
      vrChannelsHudDragTargetRef: createMutableRef(new THREE.Vector3()),
      vrTracksHudDragTargetRef: createMutableRef(new THREE.Vector3()),
      vrHudOffsetTempRef: createMutableRef(new THREE.Vector3()),
      vrHudIntersectionRef: createMutableRef(new THREE.Vector3()),
      vrChannelsLocalPointRef: createMutableRef(new THREE.Vector3()),
      vrTracksLocalPointRef: createMutableRef(new THREE.Vector3()),
      vrHudForwardRef: createMutableRef(new THREE.Vector3()),
      vrHudYawEulerRef: createMutableRef(new THREE.Euler()),
      vrHudYawQuaternionRef: createMutableRef(new THREE.Quaternion()),
      vrHudYawVectorRef: createMutableRef(new THREE.Vector3()),
      vrHudPitchVectorRef: createMutableRef(new THREE.Vector3()),
      ...
      vrHandleLocalPointRef: createMutableRef(new THREE.Vector3()),
      vrHandleWorldPointRef: createMutableRef(new THREE.Vector3()),
      vrHandleSecondaryPointRef: createMutableRef(new THREE.Vector3()),
      vrHandleDirectionTempRef: createMutableRef(new THREE.Vector3()),
      vrHandleQuaternionTempRef: createMutableRef(new THREE.Quaternion()),
      vrHandleQuaternionTemp2Ref: createMutableRef(new THREE.Quaternion()),
      sliderLocalPointRef: createMutableRef(new THREE.Vector3()),
      ...
      vrChannelsStateRef: createMutableRef({ channels: [], activeChannelId: null }),
      vrTracksStateRef: createMutableRef({ channels: [], activeChannelId: null }),
      ...
      preVrCameraStateRef: createMutableRef(null),
      xrPreferredSessionModeRef: createMutableRef('immersive-vr'),
      xrCurrentSessionModeRef: createMutableRef(null),
      xrPendingModeSwitchRef: createMutableRef(null),
      xrPassthroughSupportedRef: createMutableRef(false),
      xrFoveationAppliedRef: createMutableRef(false),
      xrPreviousFoveationRef: createMutableRef(undefined),
