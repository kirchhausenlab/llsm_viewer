...
import {
  ...
  renderVrChannelsHud as renderVrChannelsHudInternal,
  resizeVrChannelsHud as resizeVrChannelsHudInternal
} from './VolumeViewer/vrChannelsHudRenderer';
import {
  ...
  renderVrTracksHud as renderVrTracksHudInternal
} from './VolumeViewer/vrTracksHudRenderer';
import type {
  ControllerEntry,
  MovementState,
  PointerState,
...
function VolumeViewer({
  ...
  const renderVrTracksHud = useCallback((hud: VrTracksHud, state: VrTracksState) => {
    renderVrTracksHudInternal(hud, state);
  }, []);
  ...
  const renderVrChannelsHud = useCallback((hud: VrChannelsHud, state: VrChannelsState) => {
    renderVrChannelsHudInternal(hud, state, { onResize: resizeVrChannelsHud });
  }, [resizeVrChannelsHud]);
