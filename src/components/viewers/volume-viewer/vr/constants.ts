...
export const VR_WRIST_MENU_PROXIMITY_DEPTH = 0.05;
export const VR_WRIST_MENU_PROXIMITY_MARGIN = 0.025;
...
export const XR_DEPTH_NEAR = 0.01;
export const XR_DEPTH_FAR = 1000;
