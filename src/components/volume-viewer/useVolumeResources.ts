...
import { createColormapTexture } from './rendering';
...
import { getExpectedSliceBufferLength, prepareSliceTexture } from '../../utils/hoverSampling';
...
type UseVolumeResourcesParams = {
  ...
  controlsRef: MutableRefObject<import('three/examples/jsm/controls/OrbitControls') | null>;
