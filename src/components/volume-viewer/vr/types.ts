...
export type VrPlaybackHud = {
  ...
  modeLabelTexture: THREE.CanvasTexture;
  modeLabelCanvas: HTMLCanvasElement | null;
  modeLabelContext: CanvasRenderingContext2D | null;
  ...
  resetVolumeButtonHalfWidth: number;
  resetVolumeButtonHalfHeight: number;
  resetHudButtonHalfWidth: number;
  resetHudButtonHalfHeight: number;
  exitButtonHalfWidth: number;
  exitButtonHalfHeight: number;
  modeButtonHalfWidth: number;
  modeButtonHalfHeight: number;
