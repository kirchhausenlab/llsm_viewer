...
} from '../../src/hooks/dataset/channelVisibility.ts';
...
test('createAllVisibleChannelVisibility shows every distinct channel', () => {
  const visibility = createAllVisibleChannelVisibility([
    { channelId: 'channel-a' },
    { channelId: 'channel-a' },
    { channelId: 'channel-b' },
    { channelId: 'channel-c' }
