...
test('local TIFF fixture discovery reports status', () => {
  ...
  if (!fixture.available) {
    assert.equal(fixture.tiffPaths.length, 0);
...
test(
  'local TIFF fixture decodes first stack successfully',
  { skip: !fixture.available },
  async () => {
...
test(
  'fixture paths can be converted to browser File objects',
  { skip: !fixture.available },
  async () => {
